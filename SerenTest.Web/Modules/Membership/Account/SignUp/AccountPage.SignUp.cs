...
using SerenTest.Administration;
using SerenTest.Administration.Entities;
using SerenTest.Administration.Repositories;
using SerenTest.Common;
using Serenity;
using Serenity.Data;
...
namespace SerenTest.Membership.Pages
{
